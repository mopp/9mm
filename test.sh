...
try 0  'main() { return 0; }'
try 2  'main() { return bar(1, 1); } bar(int x, int y) { return x + y;}'
try 0  'main() { return fib(0); } fib(int n) { if (n <= 1) { return n; } return fib(n - 2) + fib(n - 1); }'
try 1  'main() { return fib(1); } fib(int n) { if (n <= 1) { return n; } return fib(n - 2) + fib(n - 1); }'
try 1  'main() { return fib(2); } fib(int n) { if (n <= 1) { return n; } return fib(n - 2) + fib(n - 1); }'
try 2  'main() { return fib(3); } fib(int n) { if (n <= 1) { return n; } return fib(n - 2) + fib(n - 1); }'
try 3  'main() { return fib(4); } fib(int n) { if (n <= 1) { return n; } return fib(n - 2) + fib(n - 1); }'
try 5  'main() { return fib(5); } fib(int n) { if (n <= 1) { return n; } return fib(n - 2) + fib(n - 1); }'
try 3  'main() { return f(0); } f(int n) { if (n == 3) { return n; } return f(n+1); }'
